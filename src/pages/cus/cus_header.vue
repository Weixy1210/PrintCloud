<template>
  <header class="bgLightColor1 font12" id="cusHeader">
    <div class="container">
      <!-- header Logo -->
      ...
      <div v-else class="fr cusState2 overFlowHidden btnHover2">
        ...
        <ul class="dropDownBox bgWhiteColor">
          <li><router-link to="/user/message" class="btnHover2"><img src="../../../static/img/cus_header_msg.png" class="fl">消息<div class="fr msgNumber whiteFont textCenter" v-text='this.$store.state.cusHeader.newMsg'></div></router-link></li>
          <li><router-link to="/user/order" class="btnHover2"><img src="../../../static/img/cus_header_order.png" class="fl">我的订单</router-link></li>
          <li><a @click="LogOut" class="btnHover2"><img src="../../../static/img/cus_header_logOut.png" class="fl">登出</a></li>
        </ul>
      </div>
    </div>
  </header>
